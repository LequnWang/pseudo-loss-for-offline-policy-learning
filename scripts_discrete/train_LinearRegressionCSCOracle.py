...
if __name__ == "__main__":
    ...
    parser.add_argument("--loss_type", type=str, help="l1 or l2 norm in regression")
    ...
    for lr in args.lrs:
        oracle = LinearRegressionCSCOracle(weight_decay=args.weight_decay, lr=lr, loss_type=args.loss_type)
    ...
    pseudo_loss = calculate_pseudo_loss(A_hat_valid, P_valid)
    ...
    results["pseudo_loss"] = pseudo_loss
